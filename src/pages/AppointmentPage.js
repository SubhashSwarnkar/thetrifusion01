      ...
      <section className="container mx-auto px-5 py-20">
        <Fade direction="up" triggerOnce>
          <div className="text-center mb-12">
            <h1 className="text-4xl sm:text-5xl text-theme-blue dark:text-white font-bold mb-4">
              Book a Consultation
            </h1>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-lg font-semibold text-theme-blue dark:text-white mb-2">
                    📞 Phone
                  </h3>
